...
:: Android packaging
set AND_CERT_NAME="TotemPotem"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TotemPotem.p12
...
set IOS_PROVISION=cert\TotemPotem.mobileprovision
...
set APP_ID=air.totempotem.TotemPotem

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TotemPotem
